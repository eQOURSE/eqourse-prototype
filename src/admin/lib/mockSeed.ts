...
export const seedSampleCategories = (): SampleCategory[] => [
  ...
  {
    id: "cat-publishing",
    name: "Educational Publishing Content Development",
    slug: "educational-publishing-content-development-samples",
    description: "Curriculum-aligned publishing samples for Indian and international education systems.",
    thumbnailUrl: "",
    order: 101,
  ...
  {
    id: "cat-assessment",
    name: "Assessment and Question Bank Development Services",
    slug: "assessment-question-bank-development-samples",
    description: "Assessment items, rubrics and answer keys aligned to global curricula.",
    thumbnailUrl: "",
    order: 102,
  ...
  {
    id: "cat-international-test-prep",
    name: "International Test Prep Content Development",
    slug: "international-test-prep-content-samples",
    description: "Exam-pattern content for international admissions and academic tests.",
    thumbnailUrl: "",
    order: 103,
  ...
  {
    id: "cat-national-test-prep",
    name: "National Test Prep Content Services",
    slug: "national-test-prep-content-samples",
    description: "Preparation content for leading Indian national and state examinations.",
    thumbnailUrl: "",
    order: 104,
  ...
  {
    id: "cat-academic-qa",
    name: "Academic Content Quality Assurance Services",
    slug: "academic-content-quality-assurance-samples",
    description: "Expert validation, academic review and AI training solution checks.",
    thumbnailUrl: "",
    order: 105,
  ...
  {
    id: "cat-esl",
    name: "ESL Exam Content Development",
    slug: "esl-exam-content-development-samples",
    description: "Four-skill English proficiency test content for global exams.",
    thumbnailUrl: "",
    order: 106,
  ...
  },
  {
    ...
    slug: "localization-services-samples",
    description: "Educational text and video localization by language and subject specialists.",
    thumbnailUrl: "",
    order: 107,
