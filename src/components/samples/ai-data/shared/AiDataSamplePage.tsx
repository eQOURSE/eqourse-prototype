...
const RoboticsShowcase = ({ showcases }: { showcases: SampleShowcase[] }) => {
  ...
  const previewFiles = apiFiles && apiFiles.length > 0 ? apiFiles : (current.previewFiles || []);
